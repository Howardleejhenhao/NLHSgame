...
class Level:
    ...
    def get_player_ground(self): # 在不再地板上
    ...
    def setup_level(self, layout):
        ...
        for row_index, row in enumerate(layout): # 上下
            for col_index, cell in enumerate(row): # 左右
    ...
    def horizontal_movement_collision(self):
        ...
        for sprite in self.tiles.sprites(): # 處理貼牆壁的問題
